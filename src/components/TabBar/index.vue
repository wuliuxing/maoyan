    ...
    <footer id="footer">
        <ul>
            ...
            <router-link tag="li" to="/movie">
                <i class="iconfont icon-dianying"> <img src="../../assets/img/m.png" alt=""> </i>
                <p>电影</p>
            </router-link>
            <router-link tag="li" to="/cinema">
                <i class="iconfont icon-yingyuan"><img src="../../assets/img/y.png" alt=""> </i>
                <p>影院</p>
            </router-link>
            <router-link tag="li" to="/mine">
                <i class="iconfont icon-wode"> <img src="../../assets/img/w.png" alt=""> </i>
                <p>我的</p>
            </router-link>
        </ul>
    </footer>
...
#footer ul li{ flex:1; height:46px;}
...
.iconfont{width: 24px;height: 24px; display: inline-block;}
.iconfont img{width: 100%;height: 100%;}
</style>
